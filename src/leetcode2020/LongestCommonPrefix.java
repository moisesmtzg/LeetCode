	...
	public String longestCommonPrefix(String[] strs) {
		...
		for(int charIndex = 0; charIndex < strs[0].length(); charIndex++) {
			...
			for(int wordIndex = 1; wordIndex < strs.length; wordIndex++) {
				//revisamos si tama�o de la 1a palabra(charIndex) es mayor al de las otras, regresamos el prefijo que tenmos 
			...
			//le a�adimos el siguiente caracter al prefijo que tenemos
